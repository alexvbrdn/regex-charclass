...
//
//   ucd-generate property-bool /tmp/ucd-16.0.0 --chars
//
...
pub const ALPHABETIC: &'static [(char, char)] = &[
  ...
  ('ಎ', 'ಐ'), ('ಒ', 'ನ'), ('ಪ', 'ಳ'), ('ವ', 'ಹ'),
  ('ಽ', 'ೄ'), ('\u{cc6}', 'ೈ'), ('ೊ', '\u{ccc}'),
  ('\u{cd5}', '\u{cd6}'), ('ೝ', 'ೞ'), ('ೠ', '\u{ce3}'), ('ೱ', 'ೳ'),
  ('\u{d00}', 'ഌ'), ('എ', 'ഐ'), ('ഒ', 'ഺ'), ('ഽ', '\u{d44}'),
  ('െ', 'ൈ'), ('ൊ', 'ൌ'), ('ൎ', 'ൎ'), ('ൔ', '\u{d57}'),
  ('ൟ', '\u{d63}'), ('ൺ', 'ൿ'), ('\u{d81}', 'ඃ'), ('අ', 'ඖ'),
  ('ක', 'න'), ('ඳ', 'ර'), ('ල', 'ල'), ('ව', 'ෆ'),
  ...
  ('ᰀ', '\u{1c36}'), ('ᱍ', 'ᱏ'), ('ᱚ', 'ᱽ'), ('ᲀ', '\u{1c8a}'),
  ('Ა', 'Ჺ'), ('Ჽ', 'Ჿ'), ('ᳩ', 'ᳬ'), ('ᳮ', 'ᳳ'),
  ('ᳵ', 'ᳶ'), ('ᳺ', 'ᳺ'), ('ᴀ', 'ᶿ'), ('\u{1dd3}', '\u{1df4}'),
  ('Ḁ', 'ἕ'), ('Ἐ', 'Ἕ'), ('ἠ', 'ὅ'), ('Ὀ', 'Ὅ'),
  ('ὐ', 'ὗ'), ('Ὑ', 'Ὑ'), ('Ὓ', 'Ὓ'), ('Ὕ', 'Ὕ'),
  ('Ὗ', 'ώ'), ('ᾀ', 'ᾴ'), ('ᾶ', 'ᾼ'), ('ι', 'ι'),
  ('ῂ', 'ῄ'), ('ῆ', 'ῌ'), ('ῐ', 'ΐ'), ('ῖ', 'Ί'),
  ...
  ('ꙿ', 'ꛯ'), ('ꜗ', 'ꜟ'), ('Ꜣ', 'ꞈ'), ('Ꞌ', '\u{a7cd}'),
  ('Ꟑ', 'ꟑ'), ('ꟓ', 'ꟓ'), ('ꟕ', '\u{a7dc}'), ('ꟲ', 'ꠅ'),
  ...
  ('𐫉', '𐫤'), ('𐬀', '𐬵'), ('𐭀', '𐭕'), ('𐭠', '𐭲'),
  ('𐮀', '𐮑'), ('𐰀', '𐱈'), ('𐲀', '𐲲'), ('𐳀', '𐳲'),
  ('𐴀', '\u{10d27}'), ('\u{10d4a}', '\u{10d65}'),
  ('\u{10d69}', '\u{10d69}'), ('\u{10d6f}', '\u{10d85}'), ('𐺀', '𐺩'),
  ('\u{10eab}', '\u{10eac}'), ('𐺰', '𐺱'), ('\u{10ec2}', '\u{10ec4}'),
  ('\u{10efc}', '\u{10efc}'), ('𐼀', '𐼜'), ('𐼧', '𐼧'),
  ('𐼰', '𐽅'), ('𐽰', '𐾁'), ('𐾰', '𐿄'), ('𐿠', '𐿶'),
  ...
  ('𑌪', '𑌰'), ('𑌲', '𑌳'), ('𑌵', '𑌹'), ('𑌽', '𑍄'),
  ('𑍇', '𑍈'), ('𑍋', '𑍌'), ('𑍐', '𑍐'),
  ('\u{11357}', '\u{11357}'), ('𑍝', '𑍣'), ('\u{11380}', '\u{11389}'),
  ('\u{1138b}', '\u{1138b}'), ('\u{1138e}', '\u{1138e}'),
  ('\u{11390}', '\u{113b5}'), ('\u{113b7}', '\u{113c0}'),
  ('\u{113c2}', '\u{113c2}'), ('\u{113c5}', '\u{113c5}'),
  ('\u{113c7}', '\u{113ca}'), ('\u{113cc}', '\u{113cd}'),
  ('\u{113d1}', '\u{113d1}'), ('\u{113d3}', '\u{113d3}'), ('𑐀', '𑑁'),
  ...
  ('𑶓', '𑶖'), ('𑶘', '𑶘'), ('𑻠', '𑻶'), ('\u{11f00}', '𑼐'),
  ('𑼒', '\u{11f3a}'), ('𑼾', '\u{11f40}'), ('𑾰', '𑾰'),
  ('𒀀', '𒎙'), ('𒐀', '𒑮'), ('𒒀', '𒕃'), ('𒾐', '𒿰'),
  ('𓀀', '𓐯'), ('𓑁', '𓑆'), ('\u{13460}', '\u{143fa}'),
  ('𔐀', '𔙆'), ('\u{16100}', '\u{1612e}'), ('𖠀', '𖨸'),
  ('𖩀', '𖩞'), ('𖩰', '𖪾'), ('𖫐', '𖫭'), ('𖬀', '𖬯'),
  ('𖭀', '𖭃'), ('𖭣', '𖭷'), ('𖭽', '𖮏'),
  ('\u{16d40}', '\u{16d6c}'), ('𖹀', '𖹿'), ('𖼀', '𖽊'),
  ('\u{16f4f}', '𖾇'), ('\u{16f8f}', '𖾟'), ('𖿠', '𖿡'),
  ('𖿣', '𖿣'), ('𖿰', '𖿱'), ('𗀀', '𘟷'), ('𘠀', '𘳕'),
  ('\u{18cff}', '𘴈'), ('𚿰', '𚿳'), ('𚿵', '𚿻'), ('𚿽', '𚿾'),
  ('𛀀', '𛄢'), ('𛄲', '𛄲'), ('𛅐', '𛅒'), ('𛅕', '𛅕'),
  ('𛅤', '𛅧'), ('𛅰', '𛋻'), ('𛰀', '𛱪'), ('𛱰', '𛱼'),
  ('𛲀', '𛲈'), ('𛲐', '𛲙'), ('\u{1bc9e}', '\u{1bc9e}'),
  ('𝐀', '𝑔'), ('𝑖', '𝒜'), ('𝒞', '𝒟'), ('𝒢', '𝒢'),
  ('𝒥', '𝒦'), ('𝒩', '𝒬'), ('𝒮', '𝒹'), ('𝒻', '𝒻'),
  ('𝒽', '𝓃'), ('𝓅', '𝔅'), ('𝔇', '𝔊'), ('𝔍', '𝔔'),
  ('𝔖', '𝔜'), ('𝔞', '𝔹'), ('𝔻', '𝔾'), ('𝕀', '𝕄'),
  ...
  ('𞄀', '𞄬'), ('𞄷', '𞄽'), ('𞅎', '𞅎'), ('𞊐', '𞊭'),
  ('𞋀', '𞋫'), ('𞓐', '𞓫'), ('\u{1e5d0}', '\u{1e5ed}'),
  ('\u{1e5f0}', '\u{1e5f0}'), ('𞟠', '𞟦'), ('𞟨', '𞟫'),
  ('𞟭', '𞟮'), ('𞟰', '𞟾'), ('𞠀', '𞣄'), ('𞤀', '𞥃'),
...
pub const CASE_IGNORABLE: &'static [(char, char)] = &[
  ...
  ('\u{10d4e}', '\u{10d4e}'), ('\u{10d69}', '\u{10d6d}'),
  ('\u{10d6f}', '\u{10d6f}'), ('\u{10eab}', '\u{10eac}'),
  ...
  ('\u{110bd}', '\u{110bd}'), ('\u{110c2}', '\u{110c2}'),
  ...
  ('\u{11f42}', '\u{11f42}'), ('\u{11f5a}', '\u{11f5a}'),
  ('\u{13430}', '\u{13440}'), ('\u{13447}', '\u{13455}'),
  ('\u{1611e}', '\u{16129}'), ('\u{1612d}', '\u{1612f}'),
  ('\u{16af0}', '\u{16af4}'), ('\u{16b30}', '\u{16b36}'), ('𖭀', '𖭃'),
  ('\u{16d40}', '\u{16d42}'), ('\u{16d6b}', '\u{16d6c}'),
...
pub const CASED: &'static [(char, char)] = &[
  ...
  ('Ⰰ', 'ⳤ'), ('Ⳬ', 'ⳮ'), ('Ⳳ', 'ⳳ'), ('ⴀ', 'ⴥ'),
  ('ⴧ', 'ⴧ'), ('ⴭ', 'ⴭ'), ('Ꙁ', 'ꙭ'), ('Ꚁ', 'ꚝ'),
  ('Ꜣ', 'ꞇ'), ('Ꞌ', 'ꞎ'), ('Ꞑ', '\u{a7cd}'), ('Ꟑ', 'ꟑ'),
  ('ꟓ', 'ꟓ'), ('ꟕ', '\u{a7dc}'), ('ꟲ', 'ꟶ'), ('ꟸ', 'ꟺ'),
  ('ꬰ', 'ꭚ'), ('ꭜ', 'ꭩ'), ('ꭰ', 'ꮿ'), ('ﬀ', 'ﬆ'),
  ('ﬓ', 'ﬗ'), ('Ａ', 'Ｚ'), ('ａ', 'ｚ'), ('𐐀', '𐑏'),
  ('𐒰', '𐓓'), ('𐓘', '𐓻'), ('𐕰', '𐕺'), ('𐕼', '𐖊'),
  ('𐖌', '𐖒'), ('𐖔', '𐖕'), ('𐖗', '𐖡'), ('𐖣', '𐖱'),
  ('𐖳', '𐖹'), ('𐖻', '𐖼'), ('𐞀', '𐞀'), ('𐞃', '𐞅'),
  ('𐞇', '𐞰'), ('𐞲', '𐞺'), ('𐲀', '𐲲'), ('𐳀', '𐳲'),
  ('\u{10d50}', '\u{10d65}'), ('\u{10d70}', '\u{10d85}'), ('𑢠', '𑣟'),
  ('𖹀', '𖹿'), ('𝐀', '𝑔'), ('𝑖', '𝒜'), ('𝒞', '𝒟'),
  ('𝒢', '𝒢'), ('𝒥', '𝒦'), ('𝒩', '𝒬'), ('𝒮', '𝒹'),
  ('𝒻', '𝒻'), ('𝒽', '𝓃'), ('𝓅', '𝔅'), ('𝔇', '𝔊'),
  ('𝔍', '𝔔'), ('𝔖', '𝔜'), ('𝔞', '𝔹'), ('𝔻', '𝔾'),
...
pub const CHANGES_WHEN_CASEFOLDED: &'static [(char, char)] = &[
  ...
  ('Ꞷ', 'Ꞷ'), ('Ꞹ', 'Ꞹ'), ('Ꞻ', 'Ꞻ'), ('Ꞽ', 'Ꞽ'),
  ('Ꞿ', 'Ꞿ'), ('Ꟁ', 'Ꟁ'), ('Ꟃ', 'Ꟃ'), ('Ꞔ', 'Ꟈ'),
  ('Ꟊ', 'Ꟊ'), ('\u{a7cb}', '\u{a7cc}'), ('Ꟑ', 'Ꟑ'), ('Ꟗ', 'Ꟗ'),
  ('Ꟙ', 'Ꟙ'), ('\u{a7da}', '\u{a7da}'), ('\u{a7dc}', '\u{a7dc}'),
  ('Ꟶ', 'Ꟶ'), ('ꭰ', 'ꮿ'), ('ﬀ', 'ﬆ'), ('ﬓ', 'ﬗ'),
  ('Ａ', 'Ｚ'), ('𐐀', '𐐧'), ('𐒰', '𐓓'), ('𐕰', '𐕺'),
  ('𐕼', '𐖊'), ('𐖌', '𐖒'), ('𐖔', '𐖕'), ('𐲀', '𐲲'),
  ('\u{10d50}', '\u{10d65}'), ('𑢠', '𑢿'), ('𖹀', '𖹟'),
  ('𞤀', '𞤡'),
];
...
pub const CHANGES_WHEN_CASEMAPPED: &'static [(char, char)] = &[
  ...
  ('ⴀ', 'ⴥ'), ('ⴧ', 'ⴧ'), ('ⴭ', 'ⴭ'), ('Ꙁ', 'ꙭ'),
  ('Ꚁ', 'ꚛ'), ('Ꜣ', 'ꜯ'), ('Ꜳ', 'ꝯ'), ('Ꝺ', 'ꞇ'),
  ('Ꞌ', 'Ɥ'), ('Ꞑ', 'ꞔ'), ('Ꞗ', 'Ɪ'), ('Ʞ', '\u{a7cd}'),
  ('Ꟑ', 'ꟑ'), ('Ꟗ', '\u{a7dc}'), ('Ꟶ', 'ꟶ'), ('ꭓ', 'ꭓ'),
  ('ꭰ', 'ꮿ'), ('ﬀ', 'ﬆ'), ('ﬓ', 'ﬗ'), ('Ａ', 'Ｚ'),
  ('ａ', 'ｚ'), ('𐐀', '𐑏'), ('𐒰', '𐓓'), ('𐓘', '𐓻'),
  ('𐕰', '𐕺'), ('𐕼', '𐖊'), ('𐖌', '𐖒'), ('𐖔', '𐖕'),
  ('𐖗', '𐖡'), ('𐖣', '𐖱'), ('𐖳', '𐖹'), ('𐖻', '𐖼'),
  ('𐲀', '𐲲'), ('𐳀', '𐳲'), ('\u{10d50}', '\u{10d65}'),
  ('\u{10d70}', '\u{10d85}'), ('𑢠', '𑣟'), ('𖹀', '𖹿'),
  ('𞤀', '𞥃'),
];
...
pub const CHANGES_WHEN_TITLECASED: &'static [(char, char)] = &[
  ...
  ('ꞩ', 'ꞩ'), ('ꞵ', 'ꞵ'), ('ꞷ', 'ꞷ'), ('ꞹ', 'ꞹ'),
  ('ꞻ', 'ꞻ'), ('ꞽ', 'ꞽ'), ('ꞿ', 'ꞿ'), ('ꟁ', 'ꟁ'),
  ('ꟃ', 'ꟃ'), ('ꟈ', 'ꟈ'), ('ꟊ', 'ꟊ'), ('\u{a7cd}', '\u{a7cd}'),
  ('ꟑ', 'ꟑ'), ('ꟗ', 'ꟗ'), ('ꟙ', 'ꟙ'), ('\u{a7db}', '\u{a7db}'),
  ('ꟶ', 'ꟶ'), ('ꭓ', 'ꭓ'), ('ꭰ', 'ꮿ'), ('ﬀ', 'ﬆ'),
  ('ﬓ', 'ﬗ'), ('ａ', 'ｚ'), ('𐐨', '𐑏'), ('𐓘', '𐓻'),
  ('𐖗', '𐖡'), ('𐖣', '𐖱'), ('𐖳', '𐖹'), ('𐖻', '𐖼'),
  ('𐳀', '𐳲'), ('\u{10d70}', '\u{10d85}'), ('𑣀', '𑣟'),
  ('𖹠', '𖹿'), ('𞤢', '𞥃'),
];
...
pub const CHANGES_WHEN_UPPERCASED: &'static [(char, char)] = &[
  ...
  ('ꞷ', 'ꞷ'), ('ꞹ', 'ꞹ'), ('ꞻ', 'ꞻ'), ('ꞽ', 'ꞽ'),
  ('ꞿ', 'ꞿ'), ('ꟁ', 'ꟁ'), ('ꟃ', 'ꟃ'), ('ꟈ', 'ꟈ'),
  ('ꟊ', 'ꟊ'), ('\u{a7cd}', '\u{a7cd}'), ('ꟑ', 'ꟑ'), ('ꟗ', 'ꟗ'),
  ('ꟙ', 'ꟙ'), ('\u{a7db}', '\u{a7db}'), ('ꟶ', 'ꟶ'), ('ꭓ', 'ꭓ'),
  ('ꭰ', 'ꮿ'), ('ﬀ', 'ﬆ'), ('ﬓ', 'ﬗ'), ('ａ', 'ｚ'),
  ('𐐨', '𐑏'), ('𐓘', '𐓻'), ('𐖗', '𐖡'), ('𐖣', '𐖱'),
  ('𐖳', '𐖹'), ('𐖻', '𐖼'), ('𐳀', '𐳲'),
  ('\u{10d70}', '\u{10d85}'), ('𑣀', '𑣟'), ('𖹠', '𖹿'),
...
pub const DIACRITIC: &'static [(char, char)] = &[
  ...
  ('\u{135d}', '\u{135f}'), ('\u{1714}', '᜕'), ('᜴', '᜴'),
  ('\u{17c9}', '\u{17d3}'), ('\u{17dd}', '\u{17dd}'),
  ('\u{1939}', '\u{193b}'), ('\u{1a60}', '\u{1a60}'),
  ('\u{1a75}', '\u{1a7c}'), ('\u{1a7f}', '\u{1a7f}'),
  ('\u{1ab0}', '\u{1abe}'), ('\u{1ac1}', '\u{1acb}'),
  ('\u{1b34}', '\u{1b34}'), ('᭄', '᭄'), ('\u{1b6b}', '\u{1b73}'),
  ('᮪', '\u{1bab}'), ('\u{1be6}', '\u{1be6}'), ('᯲', '᯳'),
  ('\u{1c36}', '\u{1c37}'), ('ᱸ', 'ᱽ'), ('\u{1cd0}', '\u{1ce8}'),
  ('\u{1ced}', '\u{1ced}'), ('\u{1cf4}', '\u{1cf4}'), ('᳷', '\u{1cf9}'),
  ('ᴬ', 'ᵪ'), ('\u{1dc4}', '\u{1dcf}'), ('\u{1df5}', '\u{1dff}'),
  ('᾽', '᾽'), ('᾿', '῁'), ('῍', '῏'), ('῝', '῟'),
  ('῭', '`'), ('´', '῾'), ('\u{2cef}', '\u{2cf1}'), ('ⸯ', 'ⸯ'),
  ('\u{302a}', '\u{302f}'), ('\u{3099}', '゜'), ('ー', 'ー'),
  ('\u{a66f}', '\u{a66f}'), ('\u{a67c}', '\u{a67d}'), ('ꙿ', 'ꙿ'),
  ('ꚜ', 'ꚝ'), ('\u{a6f0}', '\u{a6f1}'), ('꜀', '꜡'), ('ꞈ', '꞊'),
  ('ꟸ', 'ꟹ'), ('\u{a806}', '\u{a806}'), ('\u{a82c}', '\u{a82c}'),
  ('\u{a8c4}', '\u{a8c4}'), ('\u{a8e0}', '\u{a8f1}'), ('\u{a92b}', '꤮'),
  ('꥓', '꥓'), ('\u{a9b3}', '\u{a9b3}'), ('꧀', '꧀'),
  ...
  ('𐴢', '\u{10d27}'), ('\u{10d4e}', '\u{10d4e}'),
  ('\u{10d69}', '\u{10d6d}'), ('\u{10efd}', '\u{10eff}'),
  ...
  ('\u{1133b}', '\u{1133c}'), ('𑍍', '𑍍'), ('\u{11366}', '\u{1136c}'),
  ('\u{11370}', '\u{11374}'), ('\u{113ce}', '\u{113d0}'),
  ('\u{113d2}', '\u{113d3}'), ('\u{113e1}', '\u{113e2}'),
  ...
  ('𑽁', '\u{11f42}'), ('\u{11f5a}', '\u{11f5a}'),
  ('\u{13447}', '\u{13455}'), ('\u{1612f}', '\u{1612f}'),
  ('\u{16af0}', '\u{16af4}'), ('\u{16b30}', '\u{16b36}'),
  ('\u{16d6b}', '\u{16d6c}'), ('\u{16f8f}', '𖾟'), ('𖿰', '𖿱'),
  ('𚿰', '𚿳'), ('𚿵', '𚿻'), ('𚿽', '𚿾'),
  ('\u{1cf00}', '\u{1cf2d}'), ('\u{1cf30}', '\u{1cf46}'),
...
pub const EMOJI: &'static [(char, char)] = &[
  ...
  ('🛰', '🛰'), ('🛳', '🛼'), ('🟠', '🟫'), ('🟰', '🟰'),
  ('🤌', '🤺'), ('🤼', '🥅'), ('🥇', '🧿'), ('🩰', '🩼'),
  ('🪀', '\u{1fa89}'), ('\u{1fa8f}', '\u{1fac6}'), ('🫎', '\u{1fadc}'),
  ('\u{1fadf}', '\u{1fae9}'), ('🫰', '🫸'),
];
...
pub const EXTENDER: &'static [(char, char)] = &[
  ...
  ('ꘌ', 'ꘌ'), ('ꧏ', 'ꧏ'), ('ꧦ', 'ꧦ'), ('ꩰ', 'ꩰ'),
  ('ꫝ', 'ꫝ'), ('ꫳ', 'ꫴ'), ('ｰ', 'ｰ'), ('𐞁', '𐞂'),
  ('\u{10d4e}', '\u{10d4e}'), ('\u{10d6a}', '\u{10d6a}'),
  ('\u{10d6f}', '\u{10d6f}'), ('\u{11237}', '\u{11237}'), ('𑍝', '𑍝'),
  ('\u{113d2}', '\u{113d3}'), ('𑗆', '𑗈'), ('\u{11a98}', '\u{11a98}'),
  ('𖭂', '𖭃'), ('𖿠', '𖿡'), ('𖿣', '𖿣'), ('𞄼', '𞄽'),
  ('\u{1e5ef}', '\u{1e5ef}'), ('\u{1e944}', '\u{1e946}'),
];
...
pub const GRAPHEME_BASE: &'static [(char, char)] = &[
  ...
  ('𐮙', '𐮜'), ('𐮩', '𐮯'), ('𐰀', '𐱈'), ('𐲀', '𐲲'),
  ('𐳀', '𐳲'), ('𐳺', '𐴣'), ('𐴰', '𐴹'),
  ('\u{10d40}', '\u{10d65}'), ('\u{10d6e}', '\u{10d85}'),
  ('\u{10d8e}', '\u{10d8f}'), ('𐹠', '𐹾'), ('𐺀', '𐺩'),
  ('𐺭', '𐺭'), ('𐺰', '𐺱'), ('\u{10ec2}', '\u{10ec4}'),
  ('𐼀', '𐼧'), ('𐼰', '𐽅'), ('𐽑', '𐽙'), ('𐽰', '𐾁'),
  ('𐾆', '𐾉'), ('𐾰', '𐿋'), ('𐿠', '𐿶'), ('𑀀', '𑀀'),
  ...
  ('𑌲', '𑌳'), ('𑌵', '𑌹'), ('𑌽', '𑌽'), ('𑌿', '𑌿'),
  ('𑍁', '𑍄'), ('𑍇', '𑍈'), ('𑍋', '𑍌'), ('𑍐', '𑍐'),
  ('𑍝', '𑍣'), ('\u{11380}', '\u{11389}'), ('\u{1138b}', '\u{1138b}'),
  ('\u{1138e}', '\u{1138e}'), ('\u{11390}', '\u{113b5}'),
  ('\u{113b7}', '\u{113b7}'), ('\u{113b9}', '\u{113ba}'),
  ('\u{113ca}', '\u{113ca}'), ('\u{113cc}', '\u{113cd}'),
  ('\u{113d1}', '\u{113d1}'), ('\u{113d3}', '\u{113d5}'),
  ('\u{113d7}', '\u{113d8}'), ('𑐀', '𑐷'), ('𑑀', '𑑁'),
  ('𑑅', '𑑅'), ('𑑇', '𑑛'), ('𑑝', '𑑝'), ('𑑟', '𑑡'),
  ('𑒀', '𑒯'), ('𑒱', '𑒲'), ('𑒹', '𑒹'), ('𑒻', '𑒼'),
  ('𑒾', '𑒾'), ('𑓁', '𑓁'), ('𑓄', '𑓇'), ('𑓐', '𑓙'),
  ('𑖀', '𑖮'), ('𑖰', '𑖱'), ('𑖸', '𑖻'), ('𑖾', '𑖾'),
  ...
  ('𑙁', '𑙄'), ('𑙐', '𑙙'), ('𑙠', '𑙬'), ('𑚀', '𑚪'),
  ('𑚬', '𑚬'), ('𑚮', '𑚯'), ('𑚸', '𑚹'), ('𑛀', '𑛉'),
  ('\u{116d0}', '\u{116e3}'), ('𑜀', '𑜚'), ('\u{1171e}', '\u{1171e}'),
  ('𑜠', '𑜡'), ('𑜦', '𑜦'), ('𑜰', '𑝆'), ('𑠀', '𑠮'),
  ('𑠸', '𑠸'), ('𑠻', '𑠻'), ('𑢠', '𑣲'), ('𑣿', '𑤆'),
  ('𑤉', '𑤉'), ('𑤌', '𑤓'), ('𑤕', '𑤖'), ('𑤘', '𑤯'),
  ('𑤱', '𑤵'), ('𑤷', '𑤸'), ('𑤿', '𑥂'), ('𑥄', '𑥆'),
  ...
  ('𑨿', '𑩆'), ('𑩐', '𑩐'), ('𑩗', '𑩘'), ('𑩜', '𑪉'),
  ('𑪗', '𑪗'), ('𑪚', '𑪢'), ('𑪰', '𑫸'), ('𑬀', '𑬉'),
  ('\u{11bc0}', '\u{11be1}'), ('\u{11bf0}', '\u{11bf9}'), ('𑰀', '𑰈'),
  ('𑰊', '𑰯'), ('𑰾', '𑰾'), ('𑱀', '𑱅'), ('𑱐', '𑱬'),
  ('𑱰', '𑲏'), ('𑲩', '𑲩'), ('𑲱', '𑲱'), ('𑲴', '𑲴'),
  ('𑴀', '𑴆'), ('𑴈', '𑴉'), ('𑴋', '𑴰'), ('𑵆', '𑵆'),
  ('𑵐', '𑵙'), ('𑵠', '𑵥'), ('𑵧', '𑵨'), ('𑵪', '𑶎'),
  ...
  ('𑿿', '𒎙'), ('𒐀', '𒑮'), ('𒑰', '𒑴'), ('𒒀', '𒕃'),
  ('𒾐', '𒿲'), ('𓀀', '𓐯'), ('𓑁', '𓑆'),
  ('\u{13460}', '\u{143fa}'), ('𔐀', '𔙆'), ('\u{16100}', '\u{1611d}'),
  ('\u{1612a}', '\u{1612c}'), ('\u{16130}', '\u{16139}'), ('𖠀', '𖨸'),
  ('𖩀', '𖩞'), ('𖩠', '𖩩'), ('𖩮', '𖪾'), ('𖫀', '𖫉'),
  ('𖫐', '𖫭'), ('𖫵', '𖫵'), ('𖬀', '𖬯'), ('𖬷', '𖭅'),
  ('𖭐', '𖭙'), ('𖭛', '𖭡'), ('𖭣', '𖭷'), ('𖭽', '𖮏'),
  ('\u{16d40}', '\u{16d79}'), ('𖹀', '𖺚'), ('𖼀', '𖽊'),
  ('𖽐', '𖾇'), ('𖾓', '𖾟'), ('𖿠', '𖿣'), ('𗀀', '𘟷'),
  ('𘠀', '𘳕'), ('\u{18cff}', '𘴈'), ('𚿰', '𚿳'), ('𚿵', '𚿻'),
  ('𚿽', '𚿾'), ('𛀀', '𛄢'), ('𛄲', '𛄲'), ('𛅐', '𛅒'),
  ('𛅕', '𛅕'), ('𛅤', '𛅧'), ('𛅰', '𛋻'), ('𛰀', '𛱪'),
  ('𛱰', '𛱼'), ('𛲀', '𛲈'), ('𛲐', '𛲙'), ('𛲜', '𛲜'),
  ('𛲟', '𛲟'), ('\u{1cc00}', '\u{1ccf9}'), ('\u{1cd00}', '\u{1ceb3}'),
  ('𜽐', '𜿃'), ('𝀀', '𝃵'), ('𝄀', '𝄦'), ('𝄩', '𝅘𝅥𝅲'),
  ('𝅪', '𝅬'), ('𝆃', '𝆄'), ('𝆌', '𝆩'), ('𝆮', '𝇪'),
  ('𝈀', '𝉁'), ('𝉅', '𝉅'), ('𝋀', '𝋓'), ('𝋠', '𝋳'),
  ('𝌀', '𝍖'), ('𝍠', '𝍸'), ('𝐀', '𝑔'), ('𝑖', '𝒜'),
  ...
  ('𞅀', '𞅉'), ('𞅎', '𞅏'), ('𞊐', '𞊭'), ('𞋀', '𞋫'),
  ('𞋰', '𞋹'), ('𞋿', '𞋿'), ('𞓐', '𞓫'), ('𞓰', '𞓹'),
  ('\u{1e5d0}', '\u{1e5ed}'), ('\u{1e5f0}', '\u{1e5fa}'),
  ('\u{1e5ff}', '\u{1e5ff}'), ('𞟠', '𞟦'), ('𞟨', '𞟫'),
  ('𞟭', '𞟮'), ('𞟰', '𞟾'), ('𞠀', '𞣄'), ('𞣇', '𞣏'),
  ('𞤀', '𞥃'), ('𞥋', '𞥋'), ('𞥐', '𞥙'), ('𞥞', '𞥟'),
  ('𞱱', '𞲴'), ('𞴁', '𞴽'), ('𞸀', '𞸃'), ('𞸅', '𞸟'),
  ('𞸡', '𞸢'), ('𞸤', '𞸤'), ('𞸧', '𞸧'), ('𞸩', '𞸲'),
...
pub const GRAPHEME_EXTEND: &'static [(char, char)] = &[
  ...
  ('\u{135d}', '\u{135f}'), ('\u{1712}', '᜕'), ('\u{1732}', '᜴'),
  ('\u{1752}', '\u{1753}'), ('\u{1772}', '\u{1773}'),
  ('\u{17b4}', '\u{17b5}'), ('\u{17b7}', '\u{17bd}'),
  ...
  ('\u{1ab0}', '\u{1ace}'), ('\u{1b00}', '\u{1b03}'), ('\u{1b34}', 'ᬽ'),
  ('\u{1b42}', '᭄'), ('\u{1b6b}', '\u{1b73}'), ('\u{1b80}', '\u{1b81}'),
  ('\u{1ba2}', '\u{1ba5}'), ('\u{1ba8}', '\u{1bad}'),
  ('\u{1be6}', '\u{1be6}'), ('\u{1be8}', '\u{1be9}'),
  ('\u{1bed}', '\u{1bed}'), ('\u{1bef}', '᯳'), ('\u{1c2c}', '\u{1c33}'),
  ...
  ('\u{a8c4}', '\u{a8c5}'), ('\u{a8e0}', '\u{a8f1}'),
  ('\u{a8ff}', '\u{a8ff}'), ('\u{a926}', '\u{a92d}'),
  ('\u{a947}', '\u{a951}'), ('꥓', '꥓'), ('\u{a980}', '\u{a982}'),
  ('\u{a9b3}', '\u{a9b3}'), ('\u{a9b6}', '\u{a9b9}'),
  ('\u{a9bc}', '\u{a9bd}'), ('꧀', '꧀'), ('\u{a9e5}', '\u{a9e5}'),
  ('\u{aa29}', '\u{aa2e}'), ('\u{aa31}', '\u{aa32}'),
  ('\u{aa35}', '\u{aa36}'), ('\u{aa43}', '\u{aa43}'),
  ...
  ('\u{11127}', '\u{1112b}'), ('\u{1112d}', '\u{11134}'),
  ('\u{11173}', '\u{11173}'), ('\u{11180}', '\u{11181}'),
  ('\u{111b6}', '\u{111be}'), ('𑇀', '𑇀'), ('\u{111c9}', '\u{111cc}'),
  ('\u{111cf}', '\u{111cf}'), ('\u{1122f}', '\u{11231}'),
  ...
  ('\u{11340}', '\u{11340}'), ('𑍍', '𑍍'), ('\u{11357}', '\u{11357}'),
...
pub const GRAPHEME_LINK: &'static [(char, char)] = &[
  ...
  ('\u{113ce}', '\u{113d0}'), ('\u{11442}', '\u{11442}'),
...
pub const ID_CONTINUE: &'static [(char, char)] = &[
  ...
  ('Ꜣ', 'ꞈ'), ('Ꞌ', '\u{a7cd}'), ('Ꟑ', 'ꟑ'), ('ꟓ', 'ꟓ'),
  ('ꟕ', '\u{a7dc}'), ('ꟲ', 'ꠧ'), ('\u{a82c}', '\u{a82c}'),
  ...
  ('𐴰', '𐴹'), ('\u{10d40}', '\u{10d65}'), ('\u{10d69}', '\u{10d6d}'),
  ('\u{10d6f}', '\u{10d85}'), ('𐺀', '𐺩'), ('\u{10eab}', '\u{10eac}'),
  ('𐺰', '𐺱'), ('\u{10ec2}', '\u{10ec4}'), ('\u{10efc}', '𐼜'),
  ...
  ('\u{11370}', '\u{11374}'), ('\u{11380}', '\u{11389}'),
  ('\u{1138b}', '\u{1138b}'), ('\u{1138e}', '\u{1138e}'),
  ('\u{11390}', '\u{113b5}'), ('\u{113b7}', '\u{113c0}'),
  ('\u{113c2}', '\u{113c2}'), ('\u{113c5}', '\u{113c5}'),
  ('\u{113c7}', '\u{113ca}'), ('\u{113cc}', '\u{113d3}'),
  ('\u{113e1}', '\u{113e2}'), ('𑐀', '𑑊'), ('𑑐', '𑑙'),
  ('\u{1145e}', '𑑡'), ('𑒀', '𑓅'), ('𑓇', '𑓇'), ('𑓐', '𑓙'),
  ('𑖀', '\u{115b5}'), ('𑖸', '\u{115c0}'), ('𑗘', '\u{115dd}'),
  ('𑘀', '\u{11640}'), ('𑙄', '𑙄'), ('𑙐', '𑙙'), ('𑚀', '𑚸'),
  ('𑛀', '𑛉'), ('\u{116d0}', '\u{116e3}'), ('𑜀', '𑜚'),
  ('\u{1171d}', '\u{1172b}'), ('𑜰', '𑜹'), ('𑝀', '𑝆'),
  ('𑠀', '\u{1183a}'), ('𑢠', '𑣩'), ('𑣿', '𑤆'), ('𑤉', '𑤉'),
  ('𑤌', '𑤓'), ('𑤕', '𑤖'), ('𑤘', '𑤵'), ('𑤷', '𑤸'),
  ('\u{1193b}', '\u{11943}'), ('𑥐', '𑥙'), ('𑦠', '𑦧'),
  ('𑦪', '\u{119d7}'), ('\u{119da}', '𑧡'), ('𑧣', '𑧤'),
  ('𑨀', '\u{11a3e}'), ('\u{11a47}', '\u{11a47}'), ('𑩐', '\u{11a99}'),
  ('𑪝', '𑪝'), ('𑪰', '𑫸'), ('\u{11bc0}', '\u{11be0}'),
  ('\u{11bf0}', '\u{11bf9}'), ('𑰀', '𑰈'), ('𑰊', '\u{11c36}'),
  ('\u{11c38}', '𑱀'), ('𑱐', '𑱙'), ('𑱲', '𑲏'),
  ('\u{11c92}', '\u{11ca7}'), ('𑲩', '\u{11cb6}'), ('𑴀', '𑴆'),
  ('𑴈', '𑴉'), ('𑴋', '\u{11d36}'), ('\u{11d3a}', '\u{11d3a}'),
  ...
  ('𑼾', '\u{11f42}'), ('𑽐', '\u{11f5a}'), ('𑾰', '𑾰'),
  ('𒀀', '𒎙'), ('𒐀', '𒑮'), ('𒒀', '𒕃'), ('𒾐', '𒿰'),
  ('𓀀', '𓐯'), ('\u{13440}', '\u{13455}'), ('\u{13460}', '\u{143fa}'),
  ('𔐀', '𔙆'), ('\u{16100}', '\u{16139}'), ('𖠀', '𖨸'),
  ('𖩀', '𖩞'), ('𖩠', '𖩩'), ('𖩰', '𖪾'), ('𖫀', '𖫉'),
  ('𖫐', '𖫭'), ('\u{16af0}', '\u{16af4}'), ('𖬀', '\u{16b36}'),
  ('𖭀', '𖭃'), ('𖭐', '𖭙'), ('𖭣', '𖭷'), ('𖭽', '𖮏'),
  ('\u{16d40}', '\u{16d6c}'), ('\u{16d70}', '\u{16d79}'), ('𖹀', '𖹿'),
  ('𖼀', '𖽊'), ('\u{16f4f}', '𖾇'), ('\u{16f8f}', '𖾟'),
  ('𖿠', '𖿡'), ('𖿣', '\u{16fe4}'), ('𖿰', '𖿱'), ('𗀀', '𘟷'),
  ('𘠀', '𘳕'), ('\u{18cff}', '𘴈'), ('𚿰', '𚿳'), ('𚿵', '𚿻'),
  ('𚿽', '𚿾'), ('𛀀', '𛄢'), ('𛄲', '𛄲'), ('𛅐', '𛅒'),
  ('𛅕', '𛅕'), ('𛅤', '𛅧'), ('𛅰', '𛋻'), ('𛰀', '𛱪'),
  ('𛱰', '𛱼'), ('𛲀', '𛲈'), ('𛲐', '𛲙'),
  ('\u{1bc9d}', '\u{1bc9e}'), ('\u{1ccf0}', '\u{1ccf9}'),
  ('\u{1cf00}', '\u{1cf2d}'), ('\u{1cf30}', '\u{1cf46}'),
  ...
  ('\u{1da3b}', '\u{1da6c}'), ('\u{1da75}', '\u{1da75}'),
  ('\u{1da84}', '\u{1da84}'), ('\u{1da9b}', '\u{1da9f}'),
  ('\u{1daa1}', '\u{1daaf}'), ('𝼀', '𝼞'), ('𝼥', '𝼪'),
  ('\u{1e000}', '\u{1e006}'), ('\u{1e008}', '\u{1e018}'),
  ('\u{1e01b}', '\u{1e021}'), ('\u{1e023}', '\u{1e024}'),
  ('\u{1e026}', '\u{1e02a}'), ('𞀰', '𞁭'), ('\u{1e08f}', '\u{1e08f}'),
  ('𞄀', '𞄬'), ('\u{1e130}', '𞄽'), ('𞅀', '𞅉'), ('𞅎', '𞅎'),
  ('𞊐', '\u{1e2ae}'), ('𞋀', '𞋹'), ('𞓐', '𞓹'),
  ('\u{1e5d0}', '\u{1e5fa}'), ('𞟠', '𞟦'), ('𞟨', '𞟫'),
  ('𞟭', '𞟮'), ('𞟰', '𞟾'), ('𞠀', '𞣄'),
...
pub const ID_START: &'static [(char, char)] = &[
  ...
  ('一', 'ꒌ'), ('ꓐ', 'ꓽ'), ('ꔀ', 'ꘌ'), ('ꘐ', 'ꘟ'),
  ('ꘪ', 'ꘫ'), ('Ꙁ', 'ꙮ'), ('ꙿ', 'ꚝ'), ('ꚠ', 'ꛯ'),
  ('ꜗ', 'ꜟ'), ('Ꜣ', 'ꞈ'), ('Ꞌ', '\u{a7cd}'), ('Ꟑ', 'ꟑ'),
  ('ꟓ', 'ꟓ'), ('ꟕ', '\u{a7dc}'), ('ꟲ', 'ꠁ'), ('ꠃ', 'ꠅ'),
  ('ꠇ', 'ꠊ'), ('ꠌ', 'ꠢ'), ('ꡀ', 'ꡳ'), ('ꢂ', 'ꢳ'),
  ('ꣲ', 'ꣷ'), ('ꣻ', 'ꣻ'), ('ꣽ', 'ꣾ'), ('ꤊ', 'ꤥ'),
  ('ꤰ', 'ꥆ'), ('ꥠ', 'ꥼ'), ('ꦄ', 'ꦲ'), ('ꧏ', 'ꧏ'),
  ('ꧠ', 'ꧤ'), ('ꧦ', 'ꧯ'), ('ꧺ', 'ꧾ'), ('ꨀ', 'ꨨ'),
  ...
  ('𐫀', '𐫇'), ('𐫉', '𐫤'), ('𐬀', '𐬵'), ('𐭀', '𐭕'),
  ('𐭠', '𐭲'), ('𐮀', '𐮑'), ('𐰀', '𐱈'), ('𐲀', '𐲲'),
  ('𐳀', '𐳲'), ('𐴀', '𐴣'), ('\u{10d4a}', '\u{10d65}'),
  ('\u{10d6f}', '\u{10d85}'), ('𐺀', '𐺩'), ('𐺰', '𐺱'),
  ('\u{10ec2}', '\u{10ec4}'), ('𐼀', '𐼜'), ('𐼧', '𐼧'),
  ('𐼰', '𐽅'), ('𐽰', '𐾁'), ('𐾰', '𐿄'), ('𐿠', '𐿶'),
  ('𑀃', '𑀷'), ('𑁱', '𑁲'), ('𑁵', '𑁵'), ('𑂃', '𑂯'),
  ('𑃐', '𑃨'), ('𑄃', '𑄦'), ('𑅄', '𑅄'), ('𑅇', '𑅇'),
  ('𑅐', '𑅲'), ('𑅶', '𑅶'), ('𑆃', '𑆲'), ('𑇁', '𑇄'),
  ...
  ('𑌏', '𑌐'), ('𑌓', '𑌨'), ('𑌪', '𑌰'), ('𑌲', '𑌳'),
  ('𑌵', '𑌹'), ('𑌽', '𑌽'), ('𑍐', '𑍐'), ('𑍝', '𑍡'),
  ('\u{11380}', '\u{11389}'), ('\u{1138b}', '\u{1138b}'),
  ('\u{1138e}', '\u{1138e}'), ('\u{11390}', '\u{113b5}'),
  ('\u{113b7}', '\u{113b7}'), ('\u{113d1}', '\u{113d1}'),
  ('\u{113d3}', '\u{113d3}'), ('𑐀', '𑐴'), ('𑑇', '𑑊'),
  ('𑑟', '𑑡'), ('𑒀', '𑒯'), ('𑓄', '𑓅'), ('𑓇', '𑓇'),
  ('𑖀', '𑖮'), ('𑗘', '𑗛'), ('𑘀', '𑘯'), ('𑙄', '𑙄'),
  ('𑚀', '𑚪'), ('𑚸', '𑚸'), ('𑜀', '𑜚'), ('𑝀', '𑝆'),
  ('𑠀', '𑠫'), ('𑢠', '𑣟'), ('𑣿', '𑤆'), ('𑤉', '𑤉'),
  ...
  ('𑧣', '𑧣'), ('𑨀', '𑨀'), ('𑨋', '𑨲'), ('𑨺', '𑨺'),
  ('𑩐', '𑩐'), ('𑩜', '𑪉'), ('𑪝', '𑪝'), ('𑪰', '𑫸'),
  ('\u{11bc0}', '\u{11be0}'), ('𑰀', '𑰈'), ('𑰊', '𑰮'),
  ('𑱀', '𑱀'), ('𑱲', '𑲏'), ('𑴀', '𑴆'), ('𑴈', '𑴉'),
  ('𑴋', '𑴰'), ('𑵆', '𑵆'), ('𑵠', '𑵥'), ('𑵧', '𑵨'),
  ('𑵪', '𑶉'), ('𑶘', '𑶘'), ('𑻠', '𑻲'), ('𑼂', '𑼂'),
  ('𑼄', '𑼐'), ('𑼒', '𑼳'), ('𑾰', '𑾰'), ('𒀀', '𒎙'),
  ('𒐀', '𒑮'), ('𒒀', '𒕃'), ('𒾐', '𒿰'), ('𓀀', '𓐯'),
  ('𓑁', '𓑆'), ('\u{13460}', '\u{143fa}'), ('𔐀', '𔙆'),
  ('\u{16100}', '\u{1611d}'), ('𖠀', '𖨸'), ('𖩀', '𖩞'),
  ('𖩰', '𖪾'), ('𖫐', '𖫭'), ('𖬀', '𖬯'), ('𖭀', '𖭃'),
  ('𖭣', '𖭷'), ('𖭽', '𖮏'), ('\u{16d40}', '\u{16d6c}'),
  ('𖹀', '𖹿'), ('𖼀', '𖽊'), ('𖽐', '𖽐'), ('𖾓', '𖾟'),
  ('𖿠', '𖿡'), ('𖿣', '𖿣'), ('𗀀', '𘟷'), ('𘠀', '𘳕'),
  ('\u{18cff}', '𘴈'), ('𚿰', '𚿳'), ('𚿵', '𚿻'), ('𚿽', '𚿾'),
  ('𛀀', '𛄢'), ('𛄲', '𛄲'), ('𛅐', '𛅒'), ('𛅕', '𛅕'),
  ...
  ('𝼀', '𝼞'), ('𝼥', '𝼪'), ('𞀰', '𞁭'), ('𞄀', '𞄬'),
  ('𞄷', '𞄽'), ('𞅎', '𞅎'), ('𞊐', '𞊭'), ('𞋀', '𞋫'),
  ('𞓐', '𞓫'), ('\u{1e5d0}', '\u{1e5ed}'), ('\u{1e5f0}', '\u{1e5f0}'),
  ('𞟠', '𞟦'), ('𞟨', '𞟫'), ('𞟭', '𞟮'), ('𞟰', '𞟾'),
  ('𞠀', '𞣄'), ('𞤀', '𞥃'), ('𞥋', '𞥋'), ('𞸀', '𞸃'),
  ('𞸅', '𞸟'), ('𞸡', '𞸢'), ('𞸤', '𞸤'), ('𞸧', '𞸧'),
  ('𞸩', '𞸲'), ('𞸴', '𞸷'), ('𞸹', '𞸹'), ('𞸻', '𞸻'),
...
pub const LOWERCASE: &'static [(char, char)] = &[
  ...
  ('ꞵ', 'ꞵ'), ('ꞷ', 'ꞷ'), ('ꞹ', 'ꞹ'), ('ꞻ', 'ꞻ'),
  ('ꞽ', 'ꞽ'), ('ꞿ', 'ꞿ'), ('ꟁ', 'ꟁ'), ('ꟃ', 'ꟃ'),
  ('ꟈ', 'ꟈ'), ('ꟊ', 'ꟊ'), ('\u{a7cd}', '\u{a7cd}'), ('ꟑ', 'ꟑ'),
  ('ꟓ', 'ꟓ'), ('ꟕ', 'ꟕ'), ('ꟗ', 'ꟗ'), ('ꟙ', 'ꟙ'),
  ('\u{a7db}', '\u{a7db}'), ('ꟲ', 'ꟴ'), ('ꟶ', 'ꟶ'), ('ꟸ', 'ꟺ'),
  ('ꬰ', 'ꭚ'), ('ꭜ', 'ꭩ'), ('ꭰ', 'ꮿ'), ('ﬀ', 'ﬆ'),
  ('ﬓ', 'ﬗ'), ('ａ', 'ｚ'), ('𐐨', '𐑏'), ('𐓘', '𐓻'),
  ('𐖗', '𐖡'), ('𐖣', '𐖱'), ('𐖳', '𐖹'), ('𐖻', '𐖼'),
  ('𐞀', '𐞀'), ('𐞃', '𐞅'), ('𐞇', '𐞰'), ('𐞲', '𐞺'),
...
pub const OTHER_ALPHABETIC: &'static [(char, char)] = &[
  ...
  ('\u{10eab}', '\u{10eac}'), ('\u{10efc}', '\u{10efc}'), ('𑀀', '𑀂'),
  ...
  ('\u{113c5}', '\u{113c5}'), ('\u{113c7}', '\u{113ca}'),
  ('\u{113cc}', '\u{113cd}'), ('𑐵', '𑑁'), ('\u{11443}', '𑑅'),
...
pub const OTHER_GRAPHEME_EXTEND: &'static [(char, char)] = &[
  ...
  ('ೀ', 'ೀ'), ('\u{cc2}', '\u{cc2}'), ('ೇ', 'ೈ'), ('ೊ', 'ೋ'),
  ('\u{cd5}', '\u{cd6}'), ('\u{d3e}', '\u{d3e}'), ('\u{d57}', '\u{d57}'),
  ('\u{dcf}', '\u{dcf}'), ('\u{ddf}', '\u{ddf}'), ('᜕', '᜕'),
  ('᜴', '᜴'), ('\u{1b35}', '\u{1b35}'), ('ᬻ', 'ᬻ'), ('ᬽ', 'ᬽ'),
  ('ᭃ', '᭄'), ('᮪', '᮪'), ('᯲', '᯳'), ('\u{200c}', '\u{200c}'),
  ('\u{302e}', '\u{302f}'), ('꥓', '꥓'), ('꧀', '꧀'),
  ('\u{ff9e}', '\u{ff9f}'), ('𑇀', '𑇀'), ('𑈵', '𑈵'),
  ('\u{1133e}', '\u{1133e}'), ('𑍍', '𑍍'), ('\u{11357}', '\u{11357}'),
  ('\u{113b8}', '\u{113b8}'), ('\u{113c2}', '\u{113c2}'),
  ('\u{113c5}', '\u{113c5}'), ('\u{113c7}', '\u{113c9}'),
  ('\u{113cf}', '\u{113cf}'), ('\u{114b0}', '\u{114b0}'),
  ('\u{114bd}', '\u{114bd}'), ('\u{115af}', '\u{115af}'), ('𑚶', '𑚶'),
  ('\u{11930}', '\u{11930}'), ('𑤽', '𑤽'), ('𑽁', '𑽁'),
...
pub const UPPERCASE: &'static [(char, char)] = &[
  ...
  ('Ꞹ', 'Ꞹ'), ('Ꞻ', 'Ꞻ'), ('Ꞽ', 'Ꞽ'), ('Ꞿ', 'Ꞿ'),
  ('Ꟁ', 'Ꟁ'), ('Ꟃ', 'Ꟃ'), ('Ꞔ', 'Ꟈ'), ('Ꟊ', 'Ꟊ'),
  ('\u{a7cb}', '\u{a7cc}'), ('Ꟑ', 'Ꟑ'), ('Ꟗ', 'Ꟗ'), ('Ꟙ', 'Ꟙ'),
  ('\u{a7da}', '\u{a7da}'), ('\u{a7dc}', '\u{a7dc}'), ('Ꟶ', 'Ꟶ'),
  ('Ａ', 'Ｚ'), ('𐐀', '𐐧'), ('𐒰', '𐓓'), ('𐕰', '𐕺'),
  ('𐕼', '𐖊'), ('𐖌', '𐖒'), ('𐖔', '𐖕'), ('𐲀', '𐲲'),
  ('\u{10d50}', '\u{10d65}'), ('𑢠', '𑢿'), ('𖹀', '𖹟'),
  ('𝐀', '𝐙'), ('𝐴', '𝑍'), ('𝑨', '𝒁'), ('𝒜', '𝒜'),
...
pub const XID_START: &'static [(char, char)] = &[
  ...
  ('𐬀', '𐬵'), ('𐭀', '𐭕'), ('𐭠', '𐭲'), ('𐮀', '𐮑'),
  ('𐰀', '𐱈'), ('𐲀', '𐲲'), ('𐳀', '𐳲'), ('𐴀', '𐴣'),
  ('\u{10d4a}', '\u{10d65}'), ('\u{10d6f}', '\u{10d85}'), ('𐺀', '𐺩'),
  ('𐺰', '𐺱'), ('\u{10ec2}', '\u{10ec4}'), ('𐼀', '𐼜'),
  ('𐼧', '𐼧'), ('𐼰', '𐽅'), ('𐽰', '𐾁'), ('𐾰', '𐿄'),
  ('𐿠', '𐿶'), ('𑀃', '𑀷'), ('𑁱', '𑁲'), ('𑁵', '𑁵'),
  ('𑂃', '𑂯'), ('𑃐', '𑃨'), ('𑄃', '𑄦'), ('𑅄', '𑅄'),
  ('𑅇', '𑅇'), ('𑅐', '𑅲'), ('𑅶', '𑅶'), ('𑆃', '𑆲'),
  ...
  ('𑌅', '𑌌'), ('𑌏', '𑌐'), ('𑌓', '𑌨'), ('𑌪', '𑌰'),
  ('𑌲', '𑌳'), ('𑌵', '𑌹'), ('𑌽', '𑌽'), ('𑍐', '𑍐'),
  ('𑍝', '𑍡'), ('\u{11380}', '\u{11389}'), ('\u{1138b}', '\u{1138b}'),
  ('\u{1138e}', '\u{1138e}'), ('\u{11390}', '\u{113b5}'),
  ('\u{113b7}', '\u{113b7}'), ('\u{113d1}', '\u{113d1}'),
  ('\u{113d3}', '\u{113d3}'), ('𑐀', '𑐴'), ('𑑇', '𑑊'),
  ('𑑟', '𑑡'), ('𑒀', '𑒯'), ('𑓄', '𑓅'), ('𑓇', '𑓇'),
