...
//
//   ucd-generate property-bool /tmp/ucd-15.0.0 --chars
//
...
pub const CASE_IGNORABLE: &'static [(char, char)] = &[
  ...
  ('𞓫', '\u{1e4ef}'), ('\u{1e8d0}', '\u{1e8d6}'), ('\u{1e944}', '𞥋'),
...
pub const DIACRITIC: &'static [(char, char)] = &[
  ...
  ('\u{1e2ae}', '\u{1e2ae}'), ('\u{1e2ec}', '\u{1e2ef}'),
  ('\u{1e8d0}', '\u{1e8d6}'), ('\u{1e944}', '\u{1e946}'),
  ('\u{1e948}', '\u{1e94a}'),
];
...
pub const OTHER_ALPHABETIC: &'static [(char, char)] = &[
  ...
  ('𑼾', '\u{11f40}'), ('\u{16f4f}', '\u{16f4f}'), ('𖽑', '𖾇'),
  ('\u{16f8f}', '\u{16f92}'), ('𖿰', '𖿱'), ('\u{1bc9e}', '\u{1bc9e}'),
