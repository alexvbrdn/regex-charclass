...
//
//   ucd-generate script /tmp/ucd-16.0.0 --chars
//
...
pub const ARABIC: &'static [(char, char)] = &[
  ('\u{600}', '\u{604}'), ('؆', '؋'), ('؍', '\u{61a}'), ('\u{61c}', '؞'),
  ('ؠ', 'ؿ'), ('ف', 'ي'), ('\u{656}', 'ٯ'), ('ٱ', '\u{6dc}'),
  ('۞', 'ۿ'), ('ݐ', 'ݿ'), ('ࡰ', 'ࢎ'), ('\u{890}', '\u{891}'),
  ('\u{897}', '\u{8e1}'), ('\u{8e3}', '\u{8ff}'), ('ﭐ', '﯂'),
  ('ﯓ', 'ﴽ'), ('﵀', 'ﶏ'), ('ﶒ', 'ﷇ'), ('﷏', '﷏'),
  ('ﷰ', '﷿'), ('ﹰ', 'ﹴ'), ('ﹶ', 'ﻼ'), ('𐹠', '𐹾'),
  ('\u{10ec2}', '\u{10ec4}'), ('\u{10efc}', '\u{10eff}'), ('𞸀', '𞸃'),
  ('𞸅', '𞸟'), ('𞸡', '𞸢'), ('𞸤', '𞸤'), ('𞸧', '𞸧'),
  ('𞸩', '𞸲'), ('𞸴', '𞸷'), ('𞸹', '𞸹'), ('𞸻', '𞸻'),
  ('𞹂', '𞹂'), ('𞹇', '𞹇'), ('𞹉', '𞹉'), ('𞹋', '𞹋'),
  ('𞹍', '𞹏'), ('𞹑', '𞹒'), ('𞹔', '𞹔'), ('𞹗', '𞹗'),
...
pub const COMMON: &'static [(char, char)] = &[
  ...
  ('\u{fff9}', '�'), ('𐄀', '𐄂'), ('𐄇', '𐄳'), ('𐄷', '𐄿'),
  ('𐆐', '𐆜'), ('𐇐', '𐇼'), ('𐋡', '𐋻'),
  ('\u{1bca0}', '\u{1bca3}'), ('\u{1cc00}', '\u{1ccf9}'),
  ('\u{1cd00}', '\u{1ceb3}'), ('𜽐', '𜿃'), ('𝀀', '𝃵'),
  ('𝄀', '𝄦'), ('𝄩', '𝅦'), ('𝅪', '\u{1d17a}'), ('𝆃', '𝆄'),
  ('𝆌', '𝆩'), ('𝆮', '𝇪'), ('𝋀', '𝋓'), ('𝋠', '𝋳'),
  ('𝌀', '𝍖'), ('𝍠', '𝍸'), ('𝐀', '𝑔'), ('𝑖', '𝒜'),
...
pub const CYRILLIC: &'static [(char, char)] = &[
  ('Ѐ', '\u{484}'), ('\u{487}', 'ԯ'), ('ᲀ', '\u{1c8a}'), ('ᴫ', 'ᴫ'),
  ('ᵸ', 'ᵸ'), ('\u{2de0}', '\u{2dff}'), ('Ꙁ', '\u{a69f}'),
  ('\u{fe2e}', '\u{fe2f}'), ('𞀰', '𞁭'), ('\u{1e08f}', '\u{1e08f}'),
];
...
pub const GARAY: &'static [(char, char)] = &[
  ('\u{10d40}', '\u{10d65}'), ('\u{10d69}', '\u{10d85}'),
  ('\u{10d8e}', '\u{10d8f}'),
];
...
pub const GLAGOLITIC: &'static [(char, char)] = &[
  ('Ⰰ', 'ⱟ'), ('\u{1e000}', '\u{1e006}'), ('\u{1e008}', '\u{1e018}'),
...
pub const KHITAN_SMALL_SCRIPT: &'static [(char, char)] = &[
  ('\u{16fe4}', '\u{16fe4}'), ('𘬀', '𘳕'), ('\u{18cff}', '\u{18cff}'),
];
...
pub const LATIN: &'static [(char, char)] = &[
  ...
  ('ⁱ', 'ⁱ'), ('ⁿ', 'ⁿ'), ('ₐ', 'ₜ'), ('K', 'Å'),
  ('Ⅎ', 'Ⅎ'), ('ⅎ', 'ⅎ'), ('Ⅰ', 'ↈ'), ('Ⱡ', 'Ɀ'),
  ('Ꜣ', 'ꞇ'), ('Ꞌ', '\u{a7cd}'), ('Ꟑ', 'ꟑ'), ('ꟓ', 'ꟓ'),
  ('ꟕ', '\u{a7dc}'), ('ꟲ', 'ꟿ'), ('ꬰ', 'ꭚ'), ('ꭜ', 'ꭤ'),
  ('ꭦ', 'ꭩ'), ('ﬀ', 'ﬆ'), ('Ａ', 'Ｚ'), ('ａ', 'ｚ'),
  ('𐞀', '𐞅'), ('𐞇', '𐞰'), ('𐞲', '𐞺'), ('𝼀', '𝼞'),
  ('𝼥', '𝼪'),
];
...
pub const TELUGU: &'static [(char, char)] = &[
  ('\u{c00}', 'ఌ'), ('ఎ', 'ఐ'), ('ఒ', 'న'), ('ప', 'హ'),
  ('\u{c3c}', 'ౄ'), ('\u{c46}', '\u{c48}'), ('\u{c4a}', '\u{c4d}'),
...
pub const TULU_TIGALARI: &'static [(char, char)] = &[
  ...
  ('\u{113b7}', '\u{113c0}'), ('\u{113c2}', '\u{113c2}'),
  ('\u{113c5}', '\u{113c5}'), ('\u{113c7}', '\u{113ca}'),
  ('\u{113cc}', '\u{113d5}'), ('\u{113d7}', '\u{113d8}'),
  ('\u{113e1}', '\u{113e2}'),
];
