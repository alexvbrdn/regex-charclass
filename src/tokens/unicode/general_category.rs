...
//
//   ucd-generate general-category /tmp/ucd-16.0.0 --chars --exclude surrogate
//
...
pub const LETTER: &'static [(char, char)] = &[
  ...
  ('𞀰', '𞁭'), ('𞄀', '𞄬'), ('𞄷', '𞄽'), ('𞅎', '𞅎'),
  ('𞊐', '𞊭'), ('𞋀', '𞋫'), ('𞓐', '𞓫'),
  ('\u{1e5d0}', '\u{1e5ed}'), ('\u{1e5f0}', '\u{1e5f0}'), ('𞟠', '𞟦'),
  ('𞟨', '𞟫'), ('𞟭', '𞟮'), ('𞟰', '𞟾'), ('𞠀', '𞣄'),
  ('𞤀', '𞥃'), ('𞥋', '𞥋'), ('𞸀', '𞸃'), ('𞸅', '𞸟'),
  ('𞸡', '𞸢'), ('𞸤', '𞸤'), ('𞸧', '𞸧'), ('𞸩', '𞸲'),
  ('𞸴', '𞸷'), ('𞸹', '𞸹'), ('𞸻', '𞸻'), ('𞹂', '𞹂'),
...
pub const MARK: &'static [(char, char)] = &[
  ...
  ('\u{113cc}', '\u{113d0}'), ('\u{113d2}', '\u{113d2}'),
  ('\u{113e1}', '\u{113e2}'), ('𑐵', '\u{11446}'),
  ('\u{1145e}', '\u{1145e}'), ('\u{114b0}', '\u{114c3}'),
...
pub const MODIFIER_LETTER: &'static [(char, char)] = &[
  ...
  ('𐞇', '𐞰'), ('𐞲', '𐞺'), ('\u{10d4e}', '\u{10d4e}'),
  ('\u{10d6f}', '\u{10d6f}'), ('𖭀', '𖭃'), ('\u{16d40}', '\u{16d42}'),
  ('\u{16d6b}', '\u{16d6c}'), ('𖾓', '𖾟'), ('𖿠', '𖿡'),
  ('𖿣', '𖿣'), ('𚿰', '𚿳'), ('𚿵', '𚿻'), ('𚿽', '𚿾'),
  ('𞀰', '𞁭'), ('𞄷', '𞄽'), ('𞓫', '𞓫'), ('𞥋', '𞥋'),
];
...
pub const NUMBER: &'static [(char, char)] = &[
  ...
  ('𑑐', '𑑙'), ('𑓐', '𑓙'), ('𑙐', '𑙙'), ('𑛀', '𑛉'),
  ('\u{116d0}', '\u{116e3}'), ('𑜰', '𑜻'), ('𑣠', '𑣲'),
  ('𑥐', '𑥙'), ('\u{11bf0}', '\u{11bf9}'), ('𑱐', '𑱬'),
  ('𑵐', '𑵙'), ('𑶠', '𑶩'), ('𑽐', '𑽙'), ('𑿀', '𑿔'),
  ('𒐀', '𒑮'), ('\u{16130}', '\u{16139}'), ('𖩠', '𖩩'),
  ('𖫀', '𖫉'), ('𖭐', '𖭙'), ('𖭛', '𖭡'),
  ('\u{16d70}', '\u{16d79}'), ('𖺀', '𖺖'), ('\u{1ccf0}', '\u{1ccf9}'),
  ('𝋀', '𝋓'), ('𝋠', '𝋳'), ('𝍠', '𝍸'), ('𝟎', '𝟿'),
  ('𞅀', '𞅉'), ('𞋰', '𞋹'), ('𞓰', '𞓹'),
  ('\u{1e5f1}', '\u{1e5fa}'), ('𞣇', '𞣏'), ('𞥐', '𞥙'),
  ('𞱱', '𞲫'), ('𞲭', '𞲯'), ('𞲱', '𞲴'), ('𞴁', '𞴭'),
...
pub const OTHER_LETTER: &'static [(char, char)] = &[
  ...
  ('𐩠', '𐩼'), ('𐪀', '𐪜'), ('𐫀', '𐫇'), ('𐫉', '𐫤'),
  ('𐬀', '𐬵'), ('𐭀', '𐭕'), ('𐭠', '𐭲'), ('𐮀', '𐮑'),
  ('𐰀', '𐱈'), ('𐴀', '𐴣'), ('\u{10d4a}', '\u{10d4d}'),
  ('\u{10d4f}', '\u{10d4f}'), ('𐺀', '𐺩'), ('𐺰', '𐺱'),
  ('\u{10ec2}', '\u{10ec4}'), ('𐼀', '𐼜'), ('𐼧', '𐼧'),
  ('𐼰', '𐽅'), ('𐽰', '𐾁'), ('𐾰', '𐿄'), ('𐿠', '𐿶'),
  ('𑀃', '𑀷'), ('𑁱', '𑁲'), ('𑁵', '𑁵'), ('𑂃', '𑂯'),
  ('𑃐', '𑃨'), ('𑄃', '𑄦'), ('𑅄', '𑅄'), ('𑅇', '𑅇'),
  ...
  ('𖠀', '𖨸'), ('𖩀', '𖩞'), ('𖩰', '𖪾'), ('𖫐', '𖫭'),
  ('𖬀', '𖬯'), ('𖭣', '𖭷'), ('𖭽', '𖮏'),
  ('\u{16d43}', '\u{16d6a}'), ('𖼀', '𖽊'), ('𖽐', '𖽐'),
  ('𗀀', '𘟷'), ('𘠀', '𘳕'), ('\u{18cff}', '𘴈'), ('𛀀', '𛄢'),
  ('𛄲', '𛄲'), ('𛅐', '𛅒'), ('𛅕', '𛅕'), ('𛅤', '𛅧'),
  ('𛅰', '𛋻'), ('𛰀', '𛱪'), ('𛱰', '𛱼'), ('𛲀', '𛲈'),
  ('𛲐', '𛲙'), ('𝼊', '𝼊'), ('𞄀', '𞄬'), ('𞅎', '𞅎'),
  ('𞊐', '𞊭'), ('𞋀', '𞋫'), ('𞓐', '𞓪'),
...
pub const OTHER_SYMBOL: &'static [(char, char)] = &[
  ...
  ('𐫈', '𐫈'), ('𑜿', '𑜿'), ('𑿕', '𑿜'), ('𑿡', '𑿱'),
  ('𖬼', '𖬿'), ('𖭅', '𖭅'), ('𛲜', '𛲜'),
  ('\u{1cc00}', '\u{1ccef}'), ('\u{1cd00}', '\u{1ceb3}'), ('𜽐', '𜿃'),
  ('𝀀', '𝃵'), ('𝄀', '𝄦'), ('𝄩', '𝅘𝅥𝅲'), ('𝅪', '𝅬'),
  ('𝆃', '𝆄'), ('𝆌', '𝆩'), ('𝆮', '𝇪'), ('𝈀', '𝉁'),
  ('𝉅', '𝉅'), ('𝌀', '𝍖'), ('𝠀', '𝧿'), ('𝨷', '𝨺'),
  ('𝩭', '𝩴'), ('𝩶', '𝪃'), ('𝪅', '𝪆'), ('𞅏', '𞅏'),
  ...
  ('🡐', '🡙'), ('🡠', '🢇'), ('🢐', '🢭'), ('🢰', '\u{1f8bb}'),
  ('\u{1f8c0}', '\u{1f8c1}'), ('🤀', '🩓'), ('🩠', '🩭'),
  ('🩰', '🩼'), ('🪀', '\u{1fa89}'), ('\u{1fa8f}', '\u{1fac6}'),
  ('🫎', '\u{1fadc}'), ('\u{1fadf}', '\u{1fae9}'), ('🫰', '🫸'),
  ('🬀', '🮒'), ('🮔', '\u{1fbef}'),
];
...
pub const PUNCTUATION: &'static [(char, char)] = &[
  ...
  ('𑅀', '𑅃'), ('𑅴', '𑅵'), ('𑇅', '𑇈'), ('𑇍', '𑇍'),
  ('𑇛', '𑇛'), ('𑇝', '𑇟'), ('𑈸', '𑈽'), ('𑊩', '𑊩'),
  ('\u{113d4}', '\u{113d5}'), ('\u{113d7}', '\u{113d8}'), ('𑑋', '𑑏'),
  ('𑑚', '𑑛'), ('𑑝', '𑑝'), ('𑓆', '𑓆'), ('𑗁', '𑗗'),
  ('𑙁', '𑙃'), ('𑙠', '𑙬'), ('𑚹', '𑚹'), ('𑜼', '𑜾'),
  ('𑠻', '𑠻'), ('𑥄', '𑥆'), ('𑧢', '𑧢'), ('𑨿', '𑩆'),
  ('𑪚', '𑪜'), ('𑪞', '𑪢'), ('𑬀', '𑬉'),
...
pub const SPACING_MARK: &'static [(char, char)] = &[
  ...
  ('𑍋', '𑍍'), ('\u{11357}', '\u{11357}'), ('𑍢', '𑍣'),
  ('\u{113b8}', '\u{113ba}'), ('\u{113c2}', '\u{113c2}'),
  ('\u{113c5}', '\u{113c5}'), ('\u{113c7}', '\u{113ca}'),
  ('\u{113cc}', '\u{113cd}'), ('\u{113cf}', '\u{113cf}'), ('𑐵', '𑐷'),
  ('𑑀', '𑑁'), ('𑑅', '𑑅'), ('\u{114b0}', '𑒲'), ('𑒹', '𑒹'),
  ('𑒻', '𑒾'), ('𑓁', '𑓁'), ('\u{115af}', '𑖱'), ('𑖸', '𑖻'),
  ('𑖾', '𑖾'), ('𑘰', '𑘲'), ('𑘻', '𑘼'), ('𑘾', '𑘾'),
  ('𑚬', '𑚬'), ('𑚮', '𑚯'), ('𑚶', '𑚶'),
  ('\u{1171e}', '\u{1171e}'), ('𑜠', '𑜡'), ('𑜦', '𑜦'),
  ('𑠬', '𑠮'), ('𑠸', '𑠸'), ('\u{11930}', '𑤵'), ('𑤷', '𑤸'),
  ('𑤽', '𑤽'), ('𑥀', '𑥀'), ('𑥂', '𑥂'), ('𑧑', '𑧓'),
  ('𑧜', '𑧟'), ('𑧤', '𑧤'), ('𑨹', '𑨹'), ('𑩗', '𑩘'),
  ('𑪗', '𑪗'), ('𑰯', '𑰯'), ('𑰾', '𑰾'), ('𑲩', '𑲩'),
  ('𑲱', '𑲱'), ('𑲴', '𑲴'), ('𑶊', '𑶎'), ('𑶓', '𑶔'),
  ('𑶖', '𑶖'), ('𑻵', '𑻶'), ('𑼃', '𑼃'), ('𑼴', '𑼵'),
  ('𑼾', '𑼿'), ('𑽁', '𑽁'), ('\u{1612a}', '\u{1612c}'),
  ('𖽑', '𖾇'), ('𖿰', '𖿱'), ('\u{1d165}', '𝅦'),
  ('𝅭', '\u{1d172}'),
];
...
pub const UPPERCASE_LETTER: &'static [(char, char)] = &[
  ...
  ('Ʞ', 'Ꞵ'), ('Ꞷ', 'Ꞷ'), ('Ꞹ', 'Ꞹ'), ('Ꞻ', 'Ꞻ'),
  ('Ꞽ', 'Ꞽ'), ('Ꞿ', 'Ꞿ'), ('Ꟁ', 'Ꟁ'), ('Ꟃ', 'Ꟃ'),
  ('Ꞔ', 'Ꟈ'), ('Ꟊ', 'Ꟊ'), ('\u{a7cb}', '\u{a7cc}'), ('Ꟑ', 'Ꟑ'),
  ('Ꟗ', 'Ꟗ'), ('Ꟙ', 'Ꟙ'), ('\u{a7da}', '\u{a7da}'),
  ('\u{a7dc}', '\u{a7dc}'), ('Ꟶ', 'Ꟶ'), ('Ａ', 'Ｚ'), ('𐐀', '𐐧'),
  ('𐒰', '𐓓'), ('𐕰', '𐕺'), ('𐕼', '𐖊'), ('𐖌', '𐖒'),
  ('𐖔', '𐖕'), ('𐲀', '𐲲'), ('\u{10d50}', '\u{10d65}'),
  ('𑢠', '𑢿'), ('𖹀', '𖹟'), ('𝐀', '𝐙'), ('𝐴', '𝑍'),
  ('𝑨', '𝒁'), ('𝒜', '𝒜'), ('𝒞', '𝒟'), ('𝒢', '𝒢'),
  ('𝒥', '𝒦'), ('𝒩', '𝒬'), ('𝒮', '𝒵'), ('𝓐', '𝓩'),
  ('𝔄', '𝔅'), ('𝔇', '𝔊'), ('𝔍', '𝔔'), ('𝔖', '𝔜'),
